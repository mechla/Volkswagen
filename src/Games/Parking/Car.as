...
package Games.Parking 
{
  ...
  public class Car extends Sprite
  {
    ...
    private var speedAcceleration:Number = .5;
    ...
    private function runGame(event:Event):void
    {
      if(_go){
        ...
        Game.instance().parking.position_hit_test();
      }
    }
    ...
    public function  carRemoveEvents():void{
      stage.removeEventListener(Event.ENTER_FRAME, runGame);			
      stage.removeEventListener(KeyboardEvent.KEY_DOWN, myOnPress);
      stage.removeEventListener(KeyboardEvent.KEY_UP, myOnRelease);
    }
    public function get go():Boolean
    {
      return _go;
    }
    
    public function set go(value:Boolean):void
    {
      _go = value;
      speed = 0;
    }
